...
public class BreadthFirstSearch {
	...
	// ajoute dans la liste de fontières tous les sommets voisins de vertex
	private void push(int vertex) {
		for (Arc arc : graph.outNeighbours(vertex)) frontier.offer(arc);
	}


	// vérifie si la destination de l'arc nextArc a déjà été atteint, si non, l'activé et ajouter nextArc à l'arbre
